var navigationservice = angular.module('navigationservice', [])
  ...
  .factory('NavigationService', function ($http) {
    ...
    var navigation = [{
      ...
      classis: "active",
      link: "https://www.willnevergrowup.com/",
      target: "_blank",
      subnav: []
    }, {
      name: "Visit Our Blog",
      classis: "active",
      link: "https://blog.willnevergrowup.com/",
      target: "_blank",
      subnav: []
    }, {
      name: "About Us",
      classis: "active",
      link: "https://www.willnevergrowup.com/about",
      target: "_blank",
      subnav: []
    }, {
      name: "Packages",
    ...
    return {
      ...
      sendSubEmail: function (email) {
        return $http.get('https://admin.willnevergrowup.com/index.php/json/sendSubscribe?email=' + email, {}, {
      ...
      sendEnquiry: function (name, email, comment, phone) {
        ...
        return $http.get('https://admin.willnevergrowup.com/index.php/json/sendMail?name=' + name + '&email=' + email + '&comment=' + comment + '&phone=' + phone, {}, {
          withCredentials: true
        });
